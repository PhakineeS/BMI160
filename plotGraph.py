...
def animate(i, xs, ys1, ys2, ys3, ys4, ys5, ys6):
    ...
    with open("imu_data.csv", 'r') as file:
        ...
        for row in csvreader:
            print("Ploting . . .")
            ys1.append(int(row[0])) #/16384*gravity)
            ys2.append(int(row[1])) #/16384*gravity)
            ys3.append(int(row[2])) #/16384*gravity)
            ys4.append(int(row[3])) #/16.4)
            ys5.append(int(row[4])) #/16.4)
            ys6.append(int(row[5])) #/16.4)
            cnt += 1
